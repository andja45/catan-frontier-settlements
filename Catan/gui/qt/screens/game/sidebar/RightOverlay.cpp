...
RightOverlay::RightOverlay(std::vector<Player*>& players, Bank* bank, QWidget* parent) : m_bank(bank), QWidget(parent) {
    ...
    for (int i = 0; i < m_players.size(); ++i) {
        ...
        uiRow.resources->setSpec({CardKind::Resource, CardFace::FaceDown, ResourceType::None, DevCardType::None,
                                  m_players[i]->getNumOfResourceCards()});
        pl->addWidget(uiRow.resources);

        uiRow.devs = new QCard(p);
        uiRow.devs->setSpec({CardKind::Development, CardFace::FaceDown, ResourceType::None, DevCardType::None,
...
void RightOverlay::buildBankUi(FloatingPanel* panel) {
    ...
    m_bankCards[0] = row->addCard({CardKind::Resource, CardFace::FaceUp, ResourceType::Wood,  DevCardType::None, m_bank->getResources()[ResourceType::Wood]});
    m_bankCards[1] = row->addCard({CardKind::Resource, CardFace::FaceUp, ResourceType::Brick, DevCardType::None, m_bank->getResources()[ResourceType::Brick]});
    m_bankCards[2] = row->addCard({CardKind::Resource, CardFace::FaceUp, ResourceType::Wool,  DevCardType::None, m_bank->getResources()[ResourceType::Wool]});
    m_bankCards[3] = row->addCard({CardKind::Resource, CardFace::FaceUp, ResourceType::Wheat, DevCardType::None, m_bank->getResources()[ResourceType::Wheat]});
    m_bankCards[4] = row->addCard({CardKind::Resource, CardFace::FaceUp, ResourceType::Ore,   DevCardType::None, m_bank->getResources()[ResourceType::Ore]});
...
void RightOverlay::buildYouUi(FloatingPanel* panel) {
    ...
    m_youCards[0] = row->addCard({CardKind::Resource, CardFace::FaceUp, ResourceType::Wood,  DevCardType::None, playerYou->getResources()[ResourceType::Wood]});
    m_youCards[1] = row->addCard({CardKind::Resource, CardFace::FaceUp, ResourceType::Brick, DevCardType::None, playerYou->getResources()[ResourceType::Brick]});
    m_youCards[2] = row->addCard({CardKind::Resource, CardFace::FaceUp, ResourceType::Wool,  DevCardType::None, playerYou->getResources()[ResourceType::Wool]});
    m_youCards[3] = row->addCard({CardKind::Resource, CardFace::FaceUp, ResourceType::Wheat, DevCardType::None, playerYou->getResources()[ResourceType::Wheat]});
    m_youCards[4] = row->addCard({CardKind::Resource, CardFace::FaceUp, ResourceType::Ore,   DevCardType::None, playerYou->getResources()[ResourceType::Ore]});
...
void RightOverlay::refreshAll() {
    ...
    // --- refresh bank cards ---
    if (m_bankCards[0]) m_bankCards[0]->setSpec({CardKind::Resource, CardFace::FaceUp, ResourceType::Wood,  DevCardType::None, m_bank->getResources()[ResourceType::Wood]});
    if (m_bankCards[1]) m_bankCards[1]->setSpec({CardKind::Resource, CardFace::FaceUp, ResourceType::Brick, DevCardType::None, m_bank->getResources()[ResourceType::Brick]});
    if (m_bankCards[2]) m_bankCards[2]->setSpec({CardKind::Resource, CardFace::FaceUp, ResourceType::Wool,  DevCardType::None, m_bank->getResources()[ResourceType::Wool]});
    if (m_bankCards[3]) m_bankCards[3]->setSpec({CardKind::Resource, CardFace::FaceUp, ResourceType::Wheat, DevCardType::None, m_bank->getResources()[ResourceType::Wheat]});
    if (m_bankCards[4]) m_bankCards[4]->setSpec({CardKind::Resource, CardFace::FaceUp, ResourceType::Ore,   DevCardType::None, m_bank->getResources()[ResourceType::Ore]});
    ...
    if (!m_players.empty()) {
        ...
        if (you) {
            if (m_youCards[0]) m_youCards[0]->setSpec({CardKind::Resource, CardFace::FaceUp, ResourceType::Wood,  DevCardType::None, you->getResources()[ResourceType::Wood]});
            if (m_youCards[1]) m_youCards[1]->setSpec({CardKind::Resource, CardFace::FaceUp, ResourceType::Brick, DevCardType::None, you->getResources()[ResourceType::Brick]});
            if (m_youCards[2]) m_youCards[2]->setSpec({CardKind::Resource, CardFace::FaceUp, ResourceType::Wool,  DevCardType::None, you->getResources()[ResourceType::Wool]});
            if (m_youCards[3]) m_youCards[3]->setSpec({CardKind::Resource, CardFace::FaceUp, ResourceType::Wheat, DevCardType::None, you->getResources()[ResourceType::Wheat]});
            if (m_youCards[4]) m_youCards[4]->setSpec({CardKind::Resource, CardFace::FaceUp, ResourceType::Ore,   DevCardType::None, you->getResources()[ResourceType::Ore]});
        }
    }
}
