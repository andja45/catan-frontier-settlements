...
std::map<ResourceType, int> TradeBankPopup::selectedResources(std::vector<QCard*> cards) const
{
...
void TradeBankPopup::paintEvent(QPaintEvent*)
{
    QPainter p(this);
...
void TradeBankPopup::resetState() {
    m_selectedGive = ResourceType::None;
    m_selectedReceive = ResourceType::None;
    m_offer.give.clear();
...
void TradeBankPopup::closeEvent(QCloseEvent* e) {
    resetState();
