...
std::array<int,18> RandomStandardMapCreator::m_standardNumberOrder = {5, 2, 6, 3, 8, 10, 9, 12, 11, 4, 8, 10, 9, 4, 5, 6, 3, 11};
const std::array<TileCoords,19> RandomStandardMapCreator::m_standardCoordinates = {{
    // Center
    { 0,   0},
...
const std::array<TileCoords,6> RandomStandardMapCreator::m_directionCoords = {{
    { 0, -1 },  // top left
    { 1, -1 },  // top right
    { 1,  0 },  // right
    { 0,  1 },  // bottom right
...
std::vector<TileDef> RandomStandardMapCreator::generateRandomBoard(){
    ...
    auto hexCoordinates = RandomStandardMapCreator::m_standardCoordinates;
    int j = 0;
...
void RandomStandardMapCreator::populatePorts(Board * board) {
...
std::unique_ptr<Board> RandomStandardMapCreator::getBoard() {
